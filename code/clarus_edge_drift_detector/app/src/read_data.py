...
def read_data() -> pd.DataFrame:
    ...
    path_data_ref = os.path.join(path_data_dir, 'winequality-red-ref.csv')
    df_ref = pd.read_csv(path_data_ref)

    path_data_new = os.path.join(path_data_dir, 'winequality-red-new.csv')
